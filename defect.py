"""
Mask R-CNN
Train on the defect dataset and implement color splash effect.
...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    python defect.py train --dataset=datasets --weights=coco

    # Resume training a model that you had trained earlier
    python3 defect.py train --dataset=datasets --weights=last
...
class DefectConfig(Config):
    ...
    NUM_CLASSES = 1 + 2  # Background + defect
...
class DefectDataset(utils.Dataset):
    ...
    def load_defect(self, dataset_dir, subset):
        """Load a subset of the defect dataset.
        dataset_dir: Root directory of the dataset.
        subset: Subset to load: train or val
        """
        # Add classes. We have only one class BPOX for now
        self.add_class("defect", 1, "BPOX")
        self.add_class("defect", 2, "DLAM")
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Train Mask R-CNN to detect defect.')
    parser.add_argument("command",
                        metavar="<command>",
                        help="'train' or 'splash'")
    parser.add_argument('--dataset', required=False,
                        metavar="/path/to/defect/dataset/",
                        help='Directory of the defect dataset')
